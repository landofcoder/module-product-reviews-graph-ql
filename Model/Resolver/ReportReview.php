...
/**
 * Create product un review report resolver
 */
class ReportReview implements ResolverInterface
{
    /**
    ...
    public function resolve(
        ...
        if (!$customerId) {
            throw new GraphQlAuthorizationException(__('Guest customers aren\'t allowed to report product review.'));
        }
