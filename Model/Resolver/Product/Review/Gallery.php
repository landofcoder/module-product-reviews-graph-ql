...
use Lof\ProductReviewsGraphQl\Model\DataProvider\GalleryDataProvider;

/**
 * Review gallery resolver
 */
class Gallery implements ResolverInterface
{
    /**
     * @var GalleryDataProvider
     */
    private $galleryDataProvider;
    ...
    public function resolve(
        ...
        return $this->galleryDataProvider->getData((int) $review->getId());
    }
}
